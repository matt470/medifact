...
class __TwigTemplate_c1bb61f38d04ea32965edb5b0fc6a58da8accdb8f609208732aefbca7e5d403d extends Template
{
    private $source;
    private $macros = [];
    ...
    <h1>Your lucky number is ";
        // line 13
        echo twig_escape_filter($this->env, (isset($context["number"]) || array_key_exists("number", $context) ? $context["number"] : (function () { throw new RuntimeError('Variable "number" does not exist.', 13, $this->source); })()), "html", null, true);
        echo "</h1>
";
    ...
    {
        return array (  110 => 13,  107 => 12,  102 => 10,  98 => 9,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    {% if is_granted('IS_AUTHENTICATED_FULLY') %}
        ...
        <p>{{ app.user.id }}</p>
        <p>Vous avez le rôle: {{ app.user.roles[0] }}.</p>
    {% endif %}

    <h1>Your lucky number is {{ number }}</h1>
{% endblock %}
", "lucky/number.html.twig", "/home/csp56/medifact/templates/lucky/number.html.twig");
    }
}
